    ...
    public void onChangeStatusApproved(OrdersDto resultDto) {
        if (resultDto.getStatus() == DbConstant.ORDER_STATUS_NOT_APPROVED) {
            ...
            if (orders.getAccountId() != null) {
                ...
                EmailUtil.getInstance().sendNotificationApprovedOrder(orders.getEmail(), orders.getCustomerName(), orders.getCode(), orders.getCreateDate(), Constant.K2_SHOP, Constant.K2_FOUNDER, Constant.URL_LOGO_K2);
            }
