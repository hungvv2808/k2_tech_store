...
public class BrandRepositoryImpl implements BrandRepositoryCustom {
    ...
    public List<BrandDto> search(BrandSearchDto searchDto) {
        ...
        sb.append("SELECT "
                ...
                + "b.create_by, "
                + "b.update_date, "
                + "acc.first_name + acc.last_name as name_update ");
        ...
        if (searchDto.getSortField() != null) {
            ...
            } else if (searchDto.getSortField().equals("description")) {
                sb.append(" b.description collate utf8_vietnamese_ci ");
        ...
        for (Object[] obj : result) {
            ...
            dto.setDescription(ValueUtil.getStringByObject(obj[2]));
    ...
    private void appendQueryFromAndWhereForSearch(StringBuilder sb, BrandSearchDto searchDto) {
        ...
        sb.append(" ON b.update_by = acc.account_id WHERE 1=1 ");
