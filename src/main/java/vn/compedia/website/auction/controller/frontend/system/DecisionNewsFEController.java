...
@Getter
@Setter
public class DecisionNewsFEController extends BaseFEController {
    @Inject
    ...
    public DecisionNewsFEController() {
    ...
    public void resetAll() {
        ...
        decisionNewsSearchDto.setPageSize(4);
    ...
    public void loadDecisionTextList() {
        decisionNews = new DecisionNews();
        decisionTextList = new ArrayList<>();
        newsList = new ArrayList<>();
        decisionNewsSearchDto = new DecisionNewsSearchDto();
