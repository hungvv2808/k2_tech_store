...
public class AccountFEController extends BaseFEController {
    ...
    public void onSaveData(){
        ...
        accountDto.setActiveToken(StringUtil.encryptPassword(StringUtil.generateSalt()));
        accountDto.setTokenExpire(DateUtil.plusMinute(new Date(), Integer.parseInt(PropertiesUtil.getProperty("auth.token.expire"))));
        ...
        //
        link = buildHttpURI() + "/frontend/account/activation.xhtml?token=" + accountDto.getActiveToken();
