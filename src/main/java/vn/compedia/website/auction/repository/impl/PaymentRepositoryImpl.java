...
public class PaymentRepositoryImpl implements PaymentRepositoryCustom {
    ...
    private void appendQueryFromAndWhereForSearch(StringBuilder sb, PaymentSearchDto searchDto) {
        sb.append(" FROM payment n, account acc, asset ass, auction_register ar, regulation rl ");
        sb.append(" WHERE ar.asset_id = ass.asset_id AND n.auction_register_id = ar.auction_register_id AND ar.account_id = acc.account_id and ar.regulation_id = rl.regulation_id and 1 = 1 ");
